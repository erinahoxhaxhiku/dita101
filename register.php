<?php include_once "header.php"; ?>
    ...
    <div class="w-50 mx-auto" style="padding-top: 100px;">
        ...
        <form action="registerLogic.php" method="POST">
            ...
            <div data-mdb-input-init class="form-outline mb-4">
                <input type="text" id="form2Example3" class="form-control" name="surname" />
                <label class="form-label" for="form2Example4">Surname</label>
            </div>

            <div data-mdb-input-init class="form-outline mb-4">
                <input type="text" id="form2Example3" class="form-control" name="username" />
            ...
            <!-- Password input -->
            <div data-mdb-input-init class="form-outline mb-4">
                <input type="password" id="form2Example4" class="form-control" name="password" />
